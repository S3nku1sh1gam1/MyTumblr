...
$acc_username = "MarkAngeloLazo";
$acc_password = "Senkuishigami@14";
$acc_fullname = "Mark Angelo Lazo";
$acc_address = "Mataas na Bayan, Mogpog, Marinduque";
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			if(isset($_REQUEST['notexist']) === true){
		      				...
		      				echo "<div class='alert alert-success' role='success'> Redirecting...</div>";
		      				...
		      				echo "<div class = 'alert alert-info' role = 'alert'> You are still logged in. Please <a href= 'account.php'> click here to proceed.<a/></div>";
		      			}
